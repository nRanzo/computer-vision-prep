...
\qa{PCA-SIFT vs. Standard SIFT Descriptor Formulation}
{How does PCA-SIFT alter the standard SIFT descriptor calculation, and why does the patch size strictly shrink from $41 \times 41$ to $39 \times 39$?
\begin{itemize}
...
\qa{SURF Optimization: Integral Images and Box Filters}
...
\qa{Scale Space Architecture: SIFT vs. SURF}
...
\qa{SURF Orientation Assignment (Haar Wavelets)}
...
\qa{The SURF Descriptor Vector and System Trade-offs}
...
\qa{GLOH vs. Standard SIFT Spatial Grid}
...
\qa{Shape Context Descriptor: Mechanics and Primary Flaw}
...
\qa{Local Binary Pattern (LBP): Structure and Advantage}
...
\qa{BRIEF Descriptor: Binary Formulation and Distance Metric}
...
\qa{ORB Architecture: Fixing BRIEF's Limitations}
...
\qa{Feature Space Matching: NN vs. NNDR}
...
\qa{Matching Evaluation: Precision vs. Recall}
